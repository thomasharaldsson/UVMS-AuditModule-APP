 ...
 *       &lt;sequence&gt;
 *         &lt;element name="key" type="{urn:search.audit.schema.fisheries.ec.europa.eu:v1}SearchKey"/&gt;
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ListCriteria)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ListCriteria that = ((ListCriteria) object);
        {
            SearchKey lhsKey;
            lhsKey = this.getKey();
            SearchKey rhsKey;
